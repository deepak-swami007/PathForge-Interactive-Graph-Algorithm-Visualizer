...
- Graph Lab with Prim's MST, Kruskal's MST, Kosaraju's SCC algorithm, and Floyd-Warshall all-pairs shortest paths.
- Planned graph algorithms such as Ford-Fulkerson.
